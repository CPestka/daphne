...
TEMPLATE_TEST_CASE("Tensor Creation", TAG_DATASTRUCTURES, double, float, uint32_t, uint64_t, int32_t, int64_t) {
    ...
    ContiguousTensor<TestType> *ct0 = DataObjectFactory::create<ContiguousTensor<TestType>>(rank0_shape, IOTA);
    ContiguousTensor<TestType> *ct1 = DataObjectFactory::create<ContiguousTensor<TestType>>(rank1_shape, IOTA);
    ContiguousTensor<TestType> *ct2 = DataObjectFactory::create<ContiguousTensor<TestType>>(rank2_shape, IOTA);
    ContiguousTensor<TestType> *ct3 = DataObjectFactory::create<ContiguousTensor<TestType>>(rank3_shape, IOTA);
    ContiguousTensor<TestType> *ct4 = DataObjectFactory::create<ContiguousTensor<TestType>>(rank4_shape, IOTA);

    ChunkedTensor<TestType> *cht0 = DataObjectFactory::create<ChunkedTensor<TestType>>(rank0_shape, rank0_chunk_shape, IOTA);
    ChunkedTensor<TestType> *cht1 = DataObjectFactory::create<ChunkedTensor<TestType>>(rank1_shape, rank1_chunk_shape, IOTA);
    ChunkedTensor<TestType> *cht2 = DataObjectFactory::create<ChunkedTensor<TestType>>(rank2_shape, rank2_chunk_shape, IOTA);
    ChunkedTensor<TestType> *cht3 = DataObjectFactory::create<ChunkedTensor<TestType>>(rank3_shape, rank3_chunk_shape, IOTA);
    ChunkedTensor<TestType> *cht4 = DataObjectFactory::create<ChunkedTensor<TestType>>(rank4_shape, rank4_chunk_shape, IOTA);
...
TEMPLATE_TEST_CASE("Tensor layout and accessors", TAG_DATASTRUCTURES, double, float, uint32_t, uint64_t, int32_t, int64_t) {
    ...
    ContiguousTensor<TestType> *ct0 = DataObjectFactory::create<ContiguousTensor<TestType>>(tensor_shape0, IOTA);
    ContiguousTensor<TestType> *ct1 = DataObjectFactory::create<ContiguousTensor<TestType>>(tensor_shape1, IOTA);

    ChunkedTensor<TestType> *cht0 = DataObjectFactory::create<ChunkedTensor<TestType>>(tensor_shape0, chunk_shape0, IOTA);
    ChunkedTensor<TestType> *cht1 = DataObjectFactory::create<ChunkedTensor<TestType>>(tensor_shape1, chunk_shape1, IOTA);
...
TEMPLATE_TEST_CASE("Tensor dicing, rechunking and conversions", TAG_DATASTRUCTURES, double, float, uint32_t, uint64_t, int32_t, int64_t) {
    std::vector<size_t> tensor_shape = {3, 4, 2};
    std::vector<size_t> chunk_shape = {2, 2, 2};

    ContiguousTensor<TestType>* ct = DataObjectFactory::create<ContiguousTensor<TestType>>(tensor_shape, IOTA);
    ChunkedTensor<TestType>* cht = DataObjectFactory::create<ChunkedTensor<TestType>>(tensor_shape, chunk_shape, IOTA);
    ...
    SECTION(".rechunk()") {
        ChunkedTensor<TestType> *cht1 = DataObjectFactory::create<ChunkedTensor<TestType>>(tensor_shape, chunk_shape, IOTA);
    ...
    SECTION("Converion: rank 2 ContiguousTensor -> DenseMatrix") {
        ContiguousTensor<TestType> *ct1 = DataObjectFactory::create<ContiguousTensor<TestType>>(std::vector<size_t>({4, 3}), IOTA);
        ContiguousTensor<TestType> *ct2 = DataObjectFactory::create<ContiguousTensor<TestType>>(std::vector<size_t>({4, 3, 3}), IOTA);
